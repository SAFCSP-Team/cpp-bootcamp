...
### Classes
it's a user-defined source of information. Class is a collection of data and information of specific areas. Class is consists of `attributes` (class members) and `methods` (functions).

for example let's take the student as a class and break it down:

what is the student `class` consists of?
Studetn attibutes(class members):
`int age;`
`String name;`
`String gender;`
`double grade;`
