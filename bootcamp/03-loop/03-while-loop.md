# While loop
## Concept
It is used when the **number of iterations is not known beforehand** and **depends on a certain condition**. It repeatedly executes the code block as long as the condition is true. 
